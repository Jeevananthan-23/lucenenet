...
namespace Lucene.Net.Replicator.Nrt
{
    ...
    public abstract class CopyJob : IComparable<CopyJob>
    {
        ...
        protected readonly JCG.List<KeyValuePair<string, FileMetaData>> toCopy;
        ...
        protected CopyJob(string reason, IDictionary<string, FileMetaData> files, ReplicaNode dest, bool highPriority, IOnceDone onceDone)
        {
            this.reason = reason;
            this.files = files;
            this.dest = dest;

 ...
 */
    ...
    public abstract class PrimaryNode : Node
    {
        ...
        internal readonly ISet<string> finishedMergedFiles = Collections.EmptySet<string>();
        ...
        public bool FlushAndRefresh()
        {
            ...
            try
            {
                completedMergeFiles = new JCG.HashSet<string>(finishedMergedFiles).AsReadOnly();
            }
            finally
            {
        ...
        public long GetLastCommitVersion()
        {
            ...
            try
            {
                ...
                return long.Parse(s);//check this
            }
            finally
            {
        ...
        private bool SetCurrentInfos(ISet<string> completedMergeFiles)
        {
            ...
            try
            {
                ...
                lastFileMetaData = filesMetaData.AsReadOnly();
        ...
        /// <exception cref="System.IO.IOException"/>
        public override void Dispose() //close equilvalent
        {
            state = "closing";
